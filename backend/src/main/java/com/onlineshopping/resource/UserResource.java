...
//		User addUser = userDao.save(user);
		...
		String subject = "NexaMart - Verify Your Email Address for User Registration";
		String message = "User Registration OTP for NexaMart: " + otp + ". Please keep it confidential.";
...
//		}
		...
		String subject = "NexaMart - Verify OTP for Forget Password";
		String message = "Forget Password Verificatoion OTP for NexaMart Website: " + otp + ". Please keep it confidential.";
