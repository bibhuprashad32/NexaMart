...
const MyCart = () => {
  ...
  const retrieveMyCart = async () => {
    const response = await axios.get(
      "http://localhost:9090/api/user/mycart?userId=" + user.id
    );
  ...
  const deleteProductFromCart = (cartId, e) => {
    fetch("http://localhost:9090/api/user/mycart/remove?cartId=" + cartId, {
      method: "GET",
      headers: {
  ...
  const checkout = (e) => {
    fetch("http://localhost:9090/api/user/order/create?userId=" + user.id, {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
        ...
        result.json().then((res) => {
          if (res.success) {
            ...
            options.handler = function (response) {
              ...
              fetch("http://localhost:9090/api/user/razorpPay/response", {
                method: "PUT",
                headers: {
                  Accept: "application/json",
                  "Content-Type": "application/json",
            ...
            if (window.Razorpay) {
              console.log("Razorpay is defined");
